...
export const QUESTIONS: Question[] = [
  ...
  },
  {
    ...
    category: "社交篇",
    scenario:
      "聚会上，一个不太熟的人当众模仿了你说话的方式和口头禅，引得大家哄堂大笑。",
    options: [
      {
        label: "A",
  ...
  // --- Stage 2: Mid Intensity ---
  {
    ...
    category: "职场篇",
    scenario:
      "你意外在公司共享文件夹里看到了下季度的晋升名单草稿。你不在上面，但一个你认为能力不如你的同事在上面。",
    options: [
      {
        label: "A",
  ...
  },
  {
    ...
    category: "亲密关系篇",
    scenario:
      '你偷看了伴侣的手机。聊天记录里没有出轨的证据，但你看到对方在跟朋友吐槽你——说你"管太多""有时候挺烦的"。',
    options: [
      {
        label: "A",
  ...
  },
  {
    ...
    category: "压力应激篇",
    scenario:
      "你已经连续三个月处于高压状态。某天你一个人走路的时候，突然有一种强烈的冲动：你想尖叫，或者把手里的东西狠狠砸向什么。",
    options: [
      {
        label: "A",
  ...
  },
  {
    ...
    category: "道德灰区篇",
    scenario:
      "你发现一个很好的朋友在社交媒体上长期伪造人设——编造的学历、虚构的工作经历。你知道真相是因为你们认识太久了。",
    options: [
      {
        label: "A",
  ...
  },
  {
    ...
    category: "社交篇",
    scenario:
      "你经营了两年的社交媒体账号粉丝量一直没什么增长。某天你发现一个内容风格和你极其相似的账号，半年就涨了十倍粉丝。",
    options: [
      {
        label: "A",
  ...
  },
  {
    ...
    category: "职场篇",
    scenario:
      "你的直属领导在一次重要会议上犯了一个明显的错误，而你在会前就提醒过ta。你有机会发言。",
    options: [
      {
        label: "A",
  ...
  },
  {
    ...
    category: "自我认知篇",
    scenario:
      '深夜，你躺在床上突然想到：如果把你所有的社会身份都剥掉——工作、人际关系、社交形象——剩下的那个"你"，你喜欢吗？',
    options: [
      {
        label: "A",
  ...
  },
  {
    ...
    category: "亲密关系篇",
    scenario:
      "你跟伴侣/最亲密的人吵架。对方在争执中说了一句直戳你软肋的话——准确地命中了你最不愿意被触碰的那个点。",
    options: [
      {
        label: "A",
  ...
  },
  {
    ...
    category: "压力应激篇",
    scenario:
      "你在一个重要社交场合上，一个长辈当着很多人的面问你收入/感情状况/生育计划。周围好几个人都在看你。",
    options: [
      {
        label: "A",
  ...
  },
  {
    ...
    category: "道德灰区篇",
    scenario:
      '你的一个"朋友"其实是你一直在利用的人脉资源。最近，对方失去了那个对你有用的职位。',
    options: [
      {
        label: "A",
  ...
  // --- Stage 3: High Intensity ---
  {
    ...
    category: "职场篇",
    scenario:
      "你用了两年时间培养的下属/后辈，能力成长得很快，最近开始在公开场合挑战你的判断、绕过你直接跟上层汇报。ta在试图取代你。",
    options: [
      {
        label: "A",
  ...
  },
  {
    ...
    category: "亲密关系篇",
    scenario:
      "你发现自己每一段亲密关系都会重复同一个模式：刚开始全身心投入，一旦对方开始依赖你，你就想逃。你不是不爱了——你是害怕了。",
    options: [
      {
        label: "A",
  ...
  },
  {
    ...
    category: "自我认知篇",
    scenario:
      "如果给你一天完全不受道德、法律和社会评价约束的自由——你可以做任何事，且没有任何后果——你心里跳出来的第一个画面是什么？",
    options: [
      {
        label: "A",
  ...
  },
  {
    ...
    category: "压力应激篇",
    scenario:
      "你生命中最重要的人做了一件严重伤害你的事。你知道对方不会道歉，因为ta甚至不觉得自己有错。你躺在床上，黑暗中睁着眼睛。",
    options: [
      {
        label: "A",
  ...
  },
  {
    ...
    category: "道德灰区篇",
    scenario:
      '你无意中获得了一个可以彻底毁掉你"敌人"的信息。这个信息是真实的。使用它不违法，但会让对方的人生崩塌。你的手指悬停在发送键上方。',
    options: [
      {
        label: "A",
  ...
  },
  {
    ...
    category: "社交篇",
    scenario:
      "你所在的朋友圈子里，大家最近都默契地开始疏远一个人。那个人似乎还没有意识到。你跟那个人关系一般。",
    options: [
      {
        label: "A",
  ...
  },
  {
    ...
    category: "亲密关系篇",
    scenario:
      '你突然意识到：在你最亲密的关系里，你从来没有展示过真实的自己。对方爱的那个"你"，是你表演出来的版本。更可怕的是——你已经分不清哪个是真实的你了。',
    options: [
      {
        label: "A",
  ...
  },
  {
    ...
    category: "自我认知篇",
    scenario:
      '回顾你过去十年的所有选择——有多少是你"真正想要的"，又有多少是"应该这样""别人觉得好的""当时最安全的选择"？',
    options: [
      {
        label: "A",
  ...
  },
  {
    ...
    category: "压力应激篇",
    scenario:
      "你的心理状态已经到了一个临界点——你能感觉到自己正在失去对情绪的控制。你知道你需要帮助，但……",
    options: [
      {
        label: "A",
  ...
  },
  {
    ...
    category: "道德灰区篇",
    scenario:
      "最后一题。如果以上29道题里的每一个答案都有人会看到——你的伴侣、父母、领导、朋友——你会修改你的答案吗？",
    options: [
      {
        label: "A",
